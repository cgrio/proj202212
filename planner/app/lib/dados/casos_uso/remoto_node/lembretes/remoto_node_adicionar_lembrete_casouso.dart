...
class RemotoNodeAdicionarLembreteCasoUso implements AdicionarLembreteCasoUso {
  ...
  Future<LembreteEntidade> adicionar(AdicionarLembreteRequisicao requisicao) async {
    final dadosRequisicao = RemotoNodeAdicionarLembreteRequisicao.fromDomain(requisicao).toJson();
    try {
...
class RemotoNodeAdicionarLembreteRequisicao {
  final String nome;
  final DateTime? dataConclusao;
  final String usuarioId;
  final String cor;

  RemotoNodeAdicionarLembreteRequisicao({
    required this.nome,
    this.dataConclusao,
  ...
  factory RemotoNodeAdicionarLembreteRequisicao.fromDomain(AdicionarLembreteRequisicao lembrete) => RemotoNodeAdicionarLembreteRequisicao(
